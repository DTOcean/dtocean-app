...
# Form implementation generated from reading ui file 'designer\high\details.ui'
#
...
class Ui_DetailsWidget(object):
    def setupUi(self, DetailsWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -9, 469, 114))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.staticLabel_1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.staticLabel_2.sizePolicy().hasHeightForWidth())
        ...
        self.staticLabel_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, DetailsWidget):
        DetailsWidget.setWindowTitle(_translate("DetailsWidget", "Details", None))
        self.headingLabel.setText(_translate("DetailsWidget", "<html><head/><body><p><span style=\" font-weight:600;\">Variable Details:</span></p></body></html>", None))
        ...
        self.staticLabel_2.setText(_translate("DetailsWidget", "Description:", None))
        self.descriptionLabel.setText(_translate("DetailsWidget", "TextLabel", None))
