...
# Form implementation generated from reading ui file 'designer\low\simcomparison.ui'
#
...
class Ui_SimComparisonWidget(object):
    def setupUi(self, SimComparisonWidget):
        ...
        self.varBox = QtGui.QComboBox(SimComparisonWidget)
        ...
        self.modBox = QtGui.QComboBox(SimComparisonWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
